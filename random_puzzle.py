...
for solver in solvers:
    ...
    # Calculate averages
    # TODO debate whether we agregate for all puzzles (even if it doesn't make sense to include the ones that were not solved) or keep the relevenat ones only (solved)
    avg_len_solution = 0
    avg_cost = 0
    ...
    output = open('A2_Output/RandomPuzzleStats.txt', 'a')
    output.write(solver + '\n')
